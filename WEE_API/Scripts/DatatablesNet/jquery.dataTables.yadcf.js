...
(function (root, factory) {
    ...
    var yadcf = (function () {
        ...
        function addRangeDateFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
            ...
            else if (columnObj.datepicker_type === 'bootstrap-daterangepicker') {
      ...
      function addRangeDateRangeFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format) {
        var fromId = "yadcf-filter-" + table_selector_jq_friendly + "-from-date-" + column_number,
          //toId = "yadcf-filter-" + table_selector_jq_friendly + "-to-date-" + column_number,
          filter_selector_string_tmp,
          filter_wrapper_id,
        ...
        //}
        //else
        if (columnObj.datepicker_type === 'bootstrap-daterangepicker') {
        ...
        function appendFilters(oTable, args, table_selector, pSettings) {
            ...
            for (columnObjKey in args) {
                if (args.hasOwnProperty(columnObjKey)) {
                    ...
                    if (data === undefined || data === null || columnObj.append_data_to_table_data !== undefined) {
                    ...
                    if ($filter_selector.length === 1) {
                        ...
                        else if (columnObj.filter_type === "range_date_range") {

                          addRangeDateRangeFilter(filter_selector_string, table_selector_jq_friendly, column_number, filter_reset_button_text, filter_default_label, date_format);
