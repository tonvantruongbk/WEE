    ...
    public class DBInitializer : DropCreateDatabaseIfModelChanges<DBContext>
    {
        ...
        protected override void Seed(DBContext context)
        {
            ...
            context.AD_Menu.AddOrUpdate(a => a.MenuID
                ...
                , new AD_Menu { MenuID = 206, MenuParentID = 2, MenuText = "Danh sách người dùng", URLAction = "/UserType", MenuIcon = "fa fa-university", MenuSort = 7, MenuSeparator = null, CanDelete = null }
               ...
               // , new AD_Menu { MenuID = 230, MenuParentID = 2, MenuText = "Người dùng Bình chọn", URLAction = "/UserRatingCompany", MenuIcon = "fa fa-puzzle-piece", MenuSort = 10, MenuSeparator = null, CanDelete = null }
                ...
                , new AD_Menu { MenuID = 92, MenuParentID = 9, MenuText = "Người Dùng và Nhóm quyền", URLAction = "/Users", MenuIcon = "fa fa-user", MenuSort = 35, MenuSeparator = null, CanDelete = null }
                , new AD_Menu { MenuID = 93, MenuParentID = 9, MenuText = "Phân quyền theo nhóm", URLAction = "/Permission", MenuIcon = "fa fa-user", MenuSort = 36, MenuSeparator = null, CanDelete = null }
           ...
           // ApplicationRoleManager.AddPermission2Role(context.Roles.First(p => p.Name == c_DefaultUser).Id, context.PERMISSIONS.First().PermissionId);
            ...
            context.Users.AddOrUpdate(a => a.Id,
               new ApplicationUser { Id = 4, LastModified = DateTime.ParseExact("10/24/2017 12:53:49", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "phuc1@gmail.com", EmailConfirmed = false, PasswordHash = "AHSxpyVD/LhXx+wROzLouxmJROg7v5fjbdJcZhKIjVDuqyvGsoyQCrSLIJ/VssPPBA==", SecurityStamp = "70a1c37c-add0-4736-987b-6f852f678981", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "phuc1@gmail.com",UserTypeID = 1}
             , new ApplicationUser { Id = 5, LastModified = DateTime.ParseExact("10/24/2017 13:06:05", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "quang123@gmail.com", EmailConfirmed = false, PasswordHash = "AKLfDOXp25spagDRViHDMs0fVB1i0qJPwZSLzGiW90NvushSC9Mp2es+2zmZ2qTBkw==", SecurityStamp = "2fa525bd-7ee9-41ea-8479-2535d04b9836", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "quang123@gmail.com",  UserTypeID = 3 }
             , new ApplicationUser { Id = 6, LastModified = DateTime.ParseExact("10/24/2017 19:08:07", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "Tonvantruongbk@gmail.com", EmailConfirmed = false, PasswordHash = "AD7b6pIoqkdmk/mnytkM0BCRuQwyF0bKXh9w1mCsHiXm4Y/wuPFKTml0xCY6nPUHAg==", SecurityStamp = "1a7c2a01-78ca-4d6f-9658-e18c0b1921c8", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "Tonvantruongbk@gmail.com",   UserTypeID = 1 }
             , new ApplicationUser { Id = 7, LastModified = DateTime.ParseExact("10/24/2017 20:15:49", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "tonvantruongbk1@gmail.com", EmailConfirmed = false, PasswordHash = "AOFsxTSc4ihT0J0IZBY4AeQHoL3T+mytaZUuUhnQrfBM9AYrDK4rzZGUyQLa+OPtdg==", SecurityStamp = "eb18b5b9-36d6-452d-a480-55d854e68305", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "tonvantruongbk1@gmail.com",   UserTypeID = 2 }
             , new ApplicationUser { Id = 8, LastModified = DateTime.ParseExact("10/24/2017 21:12:55", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "a@gmail.com", EmailConfirmed = false, PasswordHash = "AJuEIIzDksyk4WqCRZN+eNv9qgIoUvx+I3MhC5iP+lTk7vJJDtNx0Xwgxg53kYuynQ==", SecurityStamp = "605b1453-4aaf-4621-907e-b6978128931a", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "a@gmail.com",  UserTypeID = 2 }
                , new ApplicationUser { Id = 9, LastModified = DateTime.ParseExact("10/24/2017 21:57:09", "MM/dd/yyyy HH:mm:ss", CultureInfo.InvariantCulture), Inactive = false, FullName = null, Firstname = null, Lastname = null, BirthDay = null, Email = "vana@gmail.com", EmailConfirmed = false, PasswordHash = "AN+0tg/InhHiexqL9kyascAKllmHrGSddErvN6TVxNViso0JkG0QnhHcoc4h02o8aA==", SecurityStamp = "799e27ce-99d3-4b16-8c4a-cfa5f0c352c5", PhoneNumber = null, PhoneNumberConfirmed = false, TwoFactorEnabled = false, LockoutEndDateUtc = null, LockoutEnabled = true, AccessFailedCount = 0, UserName = "vana@gmail.com", UserTypeID = 3 }
            );
            context.SaveChanges();
