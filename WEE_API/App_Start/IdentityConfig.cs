...
namespace WEE_API
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            //var result = Twilio.MessageResource(ConfigurationManager.AppSettings["SMSFromPhone"], message.Destination, message.Body, "");
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>
    {
        ...
        {
            return GetUser(new DBContext(), _userId);
        }

        public static ApplicationUser GetUser(DBContext db, int _userId)
        {
        ...
        public static bool RemoveUser4Role(int _userId, int _roleId)
        {
            ...
            try
            {
                using (DBContext db = new DBContext())
                {
                    ...
                    {
                        _user.Roles.Remove(_user.Roles.FirstOrDefault(p => p.RoleId == _roleId));
                        _user.LastModified = DateTime.Now;
                        db.Entry(_user).State = EntityState.Modified;
                        db.SaveChanges();
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole, int, ApplicationUserRole>(context.Get<DBContext>()));
        }
        ...
        public static List<ApplicationRole> GetRoles()
        {
            ...
            try
            {
                using (RoleStore<ApplicationRole, int, ApplicationUserRole> db = new RoleStore<ApplicationRole, int, ApplicationUserRole>(new DBContext()))
                {
        ...
        public static bool CreateRole(ApplicationRole _role)
        {
            ...
            try
            {
                var roleManager = new RoleManager<ApplicationRole, int>(new RoleStore<ApplicationRole, int, ApplicationUserRole>(new DBContext()));
