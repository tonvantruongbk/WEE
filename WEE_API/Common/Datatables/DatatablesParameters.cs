...
namespace WEE_API.Common.Datatables
{
    ...
    public class ReponseToDatatables<T>
    {
        /// <summary>
        ...
        public List<object> yadcf_data_0 { get; set; }
        public List<object> yadcf_data_1 { get; set; }
        public List<object> yadcf_data_2 { get; set; }
        public List<object> yadcf_data_3 { get; set; }
        public List<object> yadcf_data_4 { get; set; }
        public List<object> yadcf_data_5 { get; set; }
        public List<object> yadcf_data_6 { get; set; }
        public List<object> yadcf_data_7 { get; set; }
        ...
        public Dictionary<string, List<SelectizeClass>> options { get; set; }
    }
    ...
    public class DatatablesRequest
    {
        ...
        public  List<DTFilterBase> FilterBase { get; set; }
    }

    public class DTFilterBase
    {
        public int Ydacf_Number { get; set; }
        public string Ydacf_FieldName { get; set; }
    }
