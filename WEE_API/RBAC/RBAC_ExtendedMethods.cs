    ...
    public static class RBAC_ExtendedMethods
    {
        ...
        private static int RegisterUser(this ControllerBase controller, RegisterViewModel model, ApplicationUserManager userMngr, out List<string> _errors)
        {
            ...
            try
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, Firstname = model.Firstname, Lastname = model.Lastname, FullName = model.FullName, PhoneNumber = model.Mobile, TwoFactorEnabled = Is2FAEnabled };
